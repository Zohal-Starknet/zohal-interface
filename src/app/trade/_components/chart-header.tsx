      ...
      <div className="flex h-full flex-1 items-center gap-8 overflow-auto">
        <div className="flex items-center gap-4 pl-5">
          <div className="flex flex-col">
            <span className="text-white">$3,071.27</span>
            <span className="text-sm text-[#A5A5A7]">$3,072.15</span>
          </div>
        ...
        <div className="flex flex-col gap-1">
          ...
          <span className="text-white">$3,112.30</span>
        </div>
        <VerticalDivider />
        <div className="flex flex-col gap-1 pr-4">
          <span className="text-xs text-[#A5A5A7]">24h Low</span>
          <span className="text-white">$3,001.30</span>
        </div>
      </div>
    </div>
  );
